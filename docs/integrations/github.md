...
| Work hub      | `/repos/<name>`                         | Click a card to cluster that clone's tasks, Jira, notes, PRs, and calendar. `GET /api/repos/<name>/work`. See [Dashboard — Repo work hub](../architecture/dashboard.md#repo-work-hub). |
