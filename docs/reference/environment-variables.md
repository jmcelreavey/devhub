...
| `DEVHUB_MCP_TOOLSETS`           | Comma-separated toolset allowlist for the MCP server (e.g. `notes,tasks,agents,terminal`); unset or `all` registers everything                                                                                                                                                                                                                                                        |
...
| `DEVHUB_AGENT_CLI`                      | `opencode`                      | Legacy launch-CLI mirror for agent jobs: `opencode`, `cursor`, `chatgpt`, or `antigravity`. Prefer `DEVHUB_AI_PROVIDER`. Saving a provider from `/setup` writes both. |
