      ...
      <div className="w-full" style={{ display: "flex", flexDirection: "column", gap: 18 }}>
        ...
        <div className="flex items-center gap-2 text-xs text-text-muted">
          ...
          {nextMeeting ? (
            ...
            <span className="text-text-subtle">No more meetings today - the day is yours.</span>
          )}
          <button
            type="button"
                  ...
                  return (
                    <div key={id} className="flex items-center gap-2.5 px-2 py-1" style={{ opacity: 0.55 }}>
                      ...
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="min-w-0 flex-1 truncate text-xs hover:underline text-text-muted"
                      >
                        {r.title}
                      </a>
                      <button
        ...
        <div
          className="flex flex-wrap items-center gap-x-2 gap-y-1 text-xs text-text-subtle"
        >
          {activeReviews.length > 0 && (
            <>
              <span>
