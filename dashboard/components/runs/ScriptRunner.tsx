  ...
  return (
    <div className="space-y-4">
      <div className="rounded-lg border px-3 py-2 text-xs" style={{ borderColor: "var(--border)", color: "var(--text-muted)" }}>
        <label className="block mb-1 font-medium text-text-subtle">
        ...
        <input
          ...
          spellCheck={false}
        />
        <label className="block mt-2 mb-1 font-medium text-text-subtle">
        ...
        >
          ...
          />
          <span>
            <strong className="text-text-muted">Prune</strong> on Sync skills/agents: remove
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        {noScripts ? null : scripts.map((s) => {
          ...
          return (
            ...
            >
              <div className="font-medium text-sm mb-0.5 flex items-center gap-2 text-text">
                {s.label}
                {!s.mutates && (
                  <span
                    style={{
                ...
                {isRunning && (
                  <span className="text-xs animate-pulse text-accent">
                    running…
                  </span>
                )}
              </div>
      ...
      {run && (
        <div className="rounded-lg border overflow-hidden" style={{ borderColor: "var(--border)" }}>
          ...
          >
            ...
            {!run.done && <div className="animate-pulse text-text-subtle">▌</div>}
          </pre>
        </div>
      )}
    </div>
