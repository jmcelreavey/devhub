...
export function MaterializeHonestyBanner() {
  ...
  return (
    ...
    >
      ...
      <p className="text-text-subtle">{data.message}</p>
      <ul className="mt-2 space-y-0.5 font-mono text-[11px] text-text-muted">
      ...
      <p className="mt-2 text-text-subtle">
        Edit under the plugin repo (e.g. <code>~/Developer/my-devhub-plugin/</code>), then re-run{" "}
