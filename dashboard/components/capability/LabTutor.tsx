...
export function LabTutor({
  ...
  return (
    <div className="flex flex-col gap-2">
      <div className="flex items-center gap-2 text-[10px] font-medium tracking-tight text-text-subtle">
      ...
      >
        {visible.map((m) => (
          ...
          >
            <div className="text-[10px] font-medium tracking-tight mb-1 text-text-subtle">
