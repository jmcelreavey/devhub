        ...
        >
          {targets.map((t) => (
            <button
              ...
              className="flex items-center gap-2 rounded-md px-2 py-1.5 text-left text-sm transition-colors hover:bg-[var(--bg-elevated)] disabled:opacity-40 disabled:pointer-events-none text-text"
            >
              {t.relPath === "" ? (
                <Home size={14} className="text-text-subtle" aria-hidden />
              ) : (
