...
import { repoLearnApiPath } from "@/lib/repos/learn-constants";
...
export function PersistentRepoLearnDock() {
  ...
  function showPanel() {
    // Restore via ?learn= — /repos syncs searchParams to the side panel.
    const name = repoName!;
    setRepoName(null);
  ...
  return (
    ...
    >
      <div className="flex items-center gap-2 p-2">
        <button className="min-w-0 flex-1 text-left text-text" type="button" onClick={showPanel}>
