...
import { MasterChecklistCard } from "@/components/tasks/MasterChecklistCard";
...
import { ChecklistIconPicker } from "@/components/tasks/ChecklistIconPicker";
    ...
    <div className={wrapperClass}>
      <div className={embedded ? "mb-4 flex items-start justify-between gap-3" : "page-header items-start"}>
        <div className="min-w-0 flex-1">
          ...
          <p className={`${embedded ? "mt-1 text-xs" : "page-subtitle"} text-text-subtle`}>
      ...
      {showCreate ? (
        <div className="card card-body mb-4 space-y-3">
          ...
          />
          <p id="new-checklist-scope-hint" className="text-xs text-text-subtle">
