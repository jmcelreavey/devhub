  ...
  return (
    <div ref={ref} style={{ position: "relative" }}>
      <button
        type="button"
        onClick={() => setOpen((v) => !v)}
        className="flex items-center gap-1.5 rounded px-2 py-1 text-xs transition-colors hover:bg-[var(--bg-elevated)] text-text-subtle"
          ...
          <div style={{ padding: "4px 0", borderBottom: "1px solid var(--border-muted)" }}>
            ...
            {(
              ...
              >
                ...
                <span className="text-[11px] truncate text-text-subtle">
                  {desc}
                </span>
              </button>
            ))}
          ...
          <div style={{ borderTop: "1px solid var(--border-muted)", padding: "4px 0" }}>
            {saving ? (
              ...
              <button
                ...
                className="w-full flex items-center gap-2 px-3 py-2 text-[12px] text-left transition-colors hover:bg-[var(--bg-muted)] text-text-muted"
              >
            ...
            <button
              type="button"
              onClick={handleReset}
              className="w-full flex items-center gap-2 px-3 py-2 text-[12px] text-left transition-colors hover:bg-[var(--bg-muted)] text-text-subtle"
            >
              Reset to default
            </button>
          </div>
