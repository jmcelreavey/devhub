  ...
  return (
    ...
    >
      ...
      <nav className="flex-1 overflow-y-auto overflow-x-hidden pb-2">
        ...
        {/*
          Discoverability for gated sections. Without this a new user can't tell
          the difference between "DevHub doesn't do that" and "that isn't
        ...
        */}
        {!collapsed && hiddenCount > 0 && (
          ...
          >
            {hiddenCount} more {hiddenCount === 1 ? "section" : "sections"} available - finish setup
          </Link>
        )}
      </nav>
