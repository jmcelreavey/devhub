      ...
      {items.map((d) => (
        ...
        >
          <div className="min-w-0">
            <div className="mb-0.5 flex items-center gap-1.5 font-semibold text-text">
            ...
            <Link href="/radar" className="mt-1 inline-block underline-offset-2 hover:underline text-accent">
              Open digest
            </Link>
          </div>
